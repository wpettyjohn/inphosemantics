...
function main() {
  $.getJSON("../../data/inphosemantics-directory.json", function(response) {
    dir = response;
...
//console.log( $("#beagle.environment") );
...
function renderTable(corpora, models, phrases) {
  ...
  for (var i = 0; i < corpora; i++) {
    var index = i+1;
    $("#root > tbody > tr").append(
      "<td><table class='table' id='corpus"+index+"'><thead><tr><th colspan='"+models+"'>Corpus "+index+"</th></tr></thead><tbody><tr></tr></tbody></table></td>"
    );
  }
  ...
  $("#root > tbody > tr > td > table > tbody > tr").each(function() {
    for (var i=0; i<models; i++) {
      var index = i+1;
      $(this).append(
        "<td><table class='table' id='"+$(this).closest("table").attr("id")+"Model"+index+"'><thead><tr><th colspan='2'>Model "+index+"</th></tr></thead><tbody><tr></tr></tbody></table></td>"
      );
    }
  });
  ...
  $("#root > tbody > tr > td > table > tbody > tr > td > table > tbody > tr").each(function() {
    for (var i=0; i<phrases; i++) {
      var index = i+1;
      $(this).append(
        "<td><table class='table table-striped' id='"+$(this).closest("table").attr("id")+"Phrase"+index+"'><thead><tr><th>Phrase</th><th>Similarity</th></tr></thead><tbody></tbody></table></td>"
      );
    }
  });
}
